...
const MyToysTable = ({myToy,myToys,setMyToys}) => {
	...
	const {toyPhoto,toyName,sellerName,email,subCategory,price,rating,availableQuantity,detailsDescription,_id} = myToy
  ...
  const handleDelete = _id => {
	...
	<tr>
        ...
        <td>
			...
			<button onClick={() => handleDelete(_id)} className="btn btn-circle btn-outline border-rose-200 border-dashed text-white border-2">
