...
<nav>
  ...
  <a className="link link-hover">Joy with Toy Play Awards</a>
  <a className="link link-hover">Neighborhood toy store month</a>
  <a className="link link-hover">Mission,Vission, and History</a>
  <a className="link link-hover">Market Place and Academy</a>
